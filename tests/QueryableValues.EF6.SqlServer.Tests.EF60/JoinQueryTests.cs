    ...
    public class JoinQueryTests
    {
            ...
            where T : DbContext, ITestDbContext
        {
            using (db)
            {
                ...
                var result = await (
                    from e in db.TestData
                    join v in db.AsQueryableValues(sequence) on e.Int16Value equals v
                    select e.Id
                    )
                    .ToListAsync();
            ...
            where T : DbContext, ITestDbContext
        {
            using (db)
            {
                ...
                var result = await (
                    from e in db.TestData
                    join v in db.AsQueryableValues(sequence) on e.Int32Value equals v
                    select e.Id
                    )
                    .ToListAsync();
            ...
            where T : DbContext, ITestDbContext
        {
            using (db)
            {
                ...
                var result = await (
                    from e in db.TestData
                    join v in db.AsQueryableValues(sequence) on e.Int64Value equals v
                    select e.Id
                    )
                    .ToListAsync();
            ...
            where T : DbContext, ITestDbContext
        {
            using (db)
            {
                ...
                var result = await (
                    from e in db.TestData
                    join v in db.AsQueryableValues(sequence) on e.StringValue equals v
                    select e.Id
                    )
                    .ToListAsync();
            ...
            where T : DbContext, ITestDbContext
        {
            using (db)
            {
                ...
                var result = await (
                    from e in db.TestData
                    join v in db.AsQueryableValues(sequence, isUnicode: true) on e.StringUnicodeValue equals v
                    select e.Id
                    )
                    .ToListAsync();
            ...
            where T : DbContext, ITestDbContext
        {
            using (db)
            {
                ...
                var result = await (
                    from e in db.TestData
                    join v in db.AsQueryableValues(sequence) on e.GuidValue equals v
                    select e.Id
                    )
                    .ToListAsync();
